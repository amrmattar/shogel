...
import { deleteCertificate, getCertificate } from './CertificateSkillsReducer.core'
const languageData = {
    fLanguage: [],
    fLanguageRate: [],
    fAllSkills: [],
...
export const { deleteLanguage, getLanguage, getLanguageRate } = LanguageSkillsReducer.actions