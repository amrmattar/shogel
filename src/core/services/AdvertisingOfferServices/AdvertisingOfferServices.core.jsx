...
function _GET_AllAdvsOffer(page, pagination, pageNum,searchType,keyName) {
    return API.get(`ad/list?perPage=${page}&pagination=${pagination}&page=${pageNum}&search=${searchType}&name=${keyName}`)
}
// _GET_SelectUserAdvsOffer
function _GET_SelectUserAdvsOffer(page, pagination, pageNum, userID) {
    return API.get(`ad/list?perPage=${page}&pagination=${pagination}&page=${pageNum}&user_id=${userID}`)
}
// _GET_MyAdvsOffer
function _GET_MyAdvsOffer(page, pagination, pageNum, status) {
    ...
    return API.get(`ad/my_list?perPage=${page}&pagination=${pagination}&page=${pageNum}&status_id=${status}`, requestOption)
}
...
function _GET_AdvertisingByCategory(perPage, status, categoryAdsID, ID) {
    return API.get(`ad/list?perPage=${perPage}&pagination=${status}&category[]=${categoryAdsID}&without=${ID}`)
}
