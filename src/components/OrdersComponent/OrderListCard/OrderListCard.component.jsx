    ...
    <>
      ...
      <div className={`${orderStyleHolder}`}>
        ...
        <div className="d-flex align-items-center gap-3 ">
          ...
          <p className="m-0 uLT-f-radius-sB px-3 py-1 fLT-Regular-sA cLT-secondary-bg cLT-white-text ">
            {orderStatus}
          </p>
        </div>
        {/* List Card User [Holder] */}
        <div
          className={`d-flex flex-column gap-3 justify-content-center align-items-start py-3 pe-0  ${orderStyle}`}
        >
          {/*  Order [Holder] */}
          <p className="m-0 fLT-Bold-sA cLT-support2-text">{orderTitle}</p>
          <div className="d-flex justify-content-between aling-items-end">
            ...
            {/* <div className="w-100">
              {(roll === undefined) | (roll === true) ? (
                <p
                  className={`m-0 fLT-Regular-sB cLT-gray-text w-100 xx ${
