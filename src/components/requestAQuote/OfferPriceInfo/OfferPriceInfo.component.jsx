...
const OfferPriceInfo = ({data}) => {
  ...
  const [sectionTwoData, setSectionTwoData] = useState({title:'', decription:''})
          ...
          if(homeData?.section === '2') {
              switch (homeData?.key) {
                  case 'home_section_2_title':
                      return  setSectionTwoData(sectionTwoData => ({...sectionTwoData, title: homeData.value}))
                  case 'home_section_2_description':
                      return   setSectionTwoData(sectionTwoData => ({...sectionTwoData, decription: homeData.value}))
                  default:
                      return false
              }
          }
    ...
    <>
      ...
      <div className="row m-0 p-0 d-flex justify-content-center align-items-center p-3">
        ...
        <div className="col-12 text-center px-0 pb-4">
          <p className="m-0 cLT-main-text LT-offerPrice-title-size" dangerouslySetInnerHTML={{__html: sectionTwoData?.title}}>
          </p>
        ...
        <div className="col-12 col-lg-6 px-0 d-flex flex-column justify-content-center align-items-start gap-3 py-3 ps-md-4">
          <p className="cLT-gray-text fLT-Regular-sD text-ellipsis" dangerouslySetInnerHTML={{__html: sectionTwoData?.decription}} >
          </p>
        </div>
        ...
        <div className="col-12 col-lg-6 d-flex flex-column justify-content-center cLT-secondary-opacity-3 uLT-f-radius-sB p-3 p-md-4">
          ...
          {/* Offer Price TextArea */}
             ...
             <div className="LT-details-request position-relative mb-3">
                    <Form.Label className="form-label fLT-Bold-sA cLT-main-text mb-3"> اكتب تفاصيل الطلب</Form.Label>
                    <div style={{background:'#fff'}}>
                    <TextEditorShared setDescription={setContent}  setMaxLength={setGetDescriptionLength} characterLength={maxLengthCharacter} />
                    </div>
            ...
            <NavLink to="/offer-price">
              <div className="d-flex justify-content-end align-items-center w-100">
                <div className="shadow uLT-f-radius-sB">
                  <ButtonShare onClick={handleClick} btnClasses="cLT-secondary-bg px-4 py-3 uLT-f-radius-sB" textClasses="px-4 cLT-white-text fLT-Regular-sB" innerText="التالي" />
                </div>
              </div>
            </NavLink> :
            <>
              <div className="d-flex justify-content-end align-items-center w-100">
                <div className="shadow uLT-f-radius-sB">
                  <ButtonShare onClick={() => setNextClick(!nextClick)} btnClasses="cLT-secondary-bg px-4 py-3 uLT-f-radius-sB" textClasses="px-4 cLT-white-text fLT-Regular-sB" innerText="التالي" />
                </div>
              </div>
