    ...
    return (
        <div className="container p-0">
            <div className='LT-mobileOTP-holder gap-3 '>
                <div className="imLT-main-logo uLT-img-contain my-3 LT-otp-image" > </div>
                <div className="two">
                    <OtpInput
                ...
                <div className="w-100">
                    <ButtonShare loading={buttonLoading} innerText={'التحــقق'} btnClasses={'three cLT-secondary-bg'} textClasses={'py-2 cLT-white-text fLT-Regular-sB'} />
                </div>
            </div>
        </div>
    )
