...
const AuthComponent = ({ clickMe, clickStatus }) => {
    ...
    return (
        <div className='' >
            <button ref={elementRef} onClick={() => handleLogin()} type="button" className="btn cLT-main-bg py-2 px-0 px-lg-4 uLT-f-radius-sB" >
                <p className='mb-0  px-4 cLT-white-text fLT-Regular-sC'>
                    تسجيل الدخول
                </p>
            </button>
            {loginOpen && <LoginPage open={loginOpen} setLoginOpen={setLoginOpen} setSignupOpen={setSignupOpen} setMobileOpen={setMobileOpen} />}

            {mobileOpen && <MobilePage open={mobileOpen} setLoginOpen={setLoginOpen} setSignupOpen={setSignupOpen} setMobileOpen={setMobileOpen} setMobileOTPOpen={setMobileOTPOpen} />}

            {mobileOTPOpen && <MobileOTPPage open={mobileOTPOpen} setLoginOpen={setLoginOpen} setSignupOpen={setSignupOpen} setMobileOTPOpen={setMobileOTPOpen} setMobileOpen={setMobileOpen} />}
            ...
            {swearing && <SwearingShared open={swearing} setSwearing={setSwearing} setLoginOpen={setLoginOpen} setSignupOpen={setSignupOpen} setMobileOTPOpen={setMobileOTPOpen} setMobileOpen={setMobileOpen} />}
