    ...
    return (
        <div className='container' >
            {certificatesData?.length !== 0 ?
                <Carousel keyboard={true} indicators={slideIn <= 0 ? false : true} interval={null}
                    slide={true}
                    ...
                    {certificatesData?.map((elmFile, idx) => {
                        return <Carousel.Item key={idx}  >
                            {elmFile.file.match('.mp4') ?
                                <video width="100%" style={{ height: '450px' }} controls autoPlay={true}>
                                    <source src={elmFile?.file} type="video/mp4" />
                                </video>
                                :
                                <picture className='LT-advsListCard-img' >
                                    <img style={{ height: '450px' }} src={elmFile?.file} alt="" width={'100%'} />
                                </picture>
                            }
                        </Carousel.Item>
                    })}
                ...
                <div className="d-flex flex-column justify-content-center align-items-center w-100  " style={{ height: '100% ' }}>
                    ...
                    <p className='mb-0 fLT-Bold-sD cLT-gray-text'>لا يوجد صور أو فيدوهات</p>
                </div>
            }
