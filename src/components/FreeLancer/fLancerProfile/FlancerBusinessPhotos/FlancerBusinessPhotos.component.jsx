...
const FlancerBusinessPhotosComponent = ({ data ,handleClick , fileUpload}) => {
    ...
    return (
        <>
            ...
            {/* Upload Files [Holder] */}
               {/* Upload Files [Holder] */}
               <div className="">
                    <Upload inputRef={inputRef} isDrop={handleClick} targetClick={filePicker}
                        isHaveData={data?.document}
                        fileArr={fileUpload} handleDelete={handleDelete}
