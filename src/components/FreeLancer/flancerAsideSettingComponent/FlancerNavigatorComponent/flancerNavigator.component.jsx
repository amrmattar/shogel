                    ...
                    return ClientNavigators.map((navigator, ix) => {
                        return (
                            <div className='d-flex align-items-center gap-3 ' key={ix} >
                                ...
                                <NavLink aria-label={navigator.name} to={navigator.to} className={(navData) => navData.isActive ? " fLT-Bold-sA cLT-main-text uLT-list-style" : "fLT-Regular-sB cLT-support2-text uLT-list-style"} >
