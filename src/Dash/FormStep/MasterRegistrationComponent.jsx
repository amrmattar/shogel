...
const MasterRegistrationComponent = () => {
  ...
  return (
    ...
    {value.page !== 9 && (
      <Stepper steps={first} activeStep={value?.page} 
        defaultColor={'#E9E9E9'}
      ...
      {value.page === 2 || value?.accountType?.userKind === 'undo' ? <RegisterDetectedAccount /> : null}
      {value.page === 3 && value?.accountType?.userKind === 'client' &&  <RegisterClientView /> }
      {value.page === 3 && value?.accountType?.userKind === 'freelancer' && <RegisterDetectedFreelancerAccount />}
      {value.page === 4  && value?.accountType?.userKind === 'client' && <RegisterClientOptionDetails />}
      {value.page === 4  && value?.accountType?.userKind === 'worker' && <RegisterFreelancerPersonalDetails />}
      {value.page === 4  && value?.accountType?.userKind === 'company' && <RegisterCompanyDetails />}
