  ...
  return (
    <>
      <Form
        ...
        className="d-grid gap-3 p-4 uLT-f-radius-sB cLT-platinum-bg "
      >
        ...
        <div className="LT-details-request position-relative">
          ...
          <textarea
            className="LT-offerDetails-textarea form-control fLT-Regular-sB p-3 uLT-bd-f-platinum-sA fLT-Regular-sB cLT-main-text"
            rows="3"
