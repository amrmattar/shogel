...
const SideOrderDetailsPage = ({ data, isUser, offerRefresh }) => {
  ...
  const handleDeleteTask = () => {
    ...
    userOfferPrice._DELETE_TaskByID(data?.id).then(res => {
      ...
      switch (data?.user?.id) {
        ...
        default:
          return <div className="">
            ...
            <FlancerPersonalInformationComponent myData={data?.user} statusIcon={<div className="uLT-status-online"></div>} />
          </div>
      }
    },
    [data?.user?.id],
      ...
      switch (data?.freelancer && data?.freelancer?.id) {
        ...
        default:
          return <div className="">
            ...
            <FlancerPersonalInformationComponent myData={data?.freelancer} statusIcon={<div className="uLT-status-online"></div>} />
          </div>
      }
    }, [data?.freelancer])
  useEffect(() => { HandleOwnerOfJobView() }, [HandleOwnerOfJobView])
  ...
  return (
    <>
      <CancelationShared cancelRefesh={offerRefresh} cancelType={'task'} refe={cancelTaskRef} reason={cancelIsReason} advsID={cancelTaskID} id={'openModal'} dataTarget={'#myAdvertising'} modalId={'myAdvertising'} />
