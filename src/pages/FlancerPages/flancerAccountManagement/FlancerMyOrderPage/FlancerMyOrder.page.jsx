...
const FlancerMyOrderPage = () => {
    ...
    const children = {
        requestOffer: <PriceTasksListsComponent setPagination={setMyOfferPagination} offerStatus={offerFilter} type={tabType} />,
        requestMyJob: <RequestMyJobComponent setPagination={setMyOfferPagination} offerStatus={offerFilter} type={tabType} />,
        requestMade: <RequestsMadeComponent setPagination={setMyOfferPagination} offerStatus={offerFilter} type={tabType} />
    }
    ...
    useEffect(() => {
        const timeout = setTimeout(() => {
            if (!myOfferListPagination?.pagination) { return handleAdvsPagination }
        }, 1200);
    ...
    return (
        <div className='d-flex flex-column align-items-center justify-content-between gap-3 h-100'>
            <div className="w-100">
                <FlancerTabsControllerShared children={children} Datafilter={setOfferFilter} tabSelect={setTabsSelected} />
            </div>
            {pagination !== 0 &&
