      ...
      <div className=" LT-searchBar-holder-grid ">
        ...
        {checkLogin &&
          <div className="d-flex align-items-center gap-3">
            {/* Search Bar Text  */}
            {!mediaMD &&
              <div className="LT-searchBar-text text-center cLT-main-text fLT-Regular-sB x2">أو </div>
            }
            {/* Button  */}
            <div className="LT-searchBar-button w-100">
              <NavLink to="/offer-price">
                <div className="shadow uLT-f-radius-sB">
                  <ButtonShare btnClasses="cLT-secondary-bg p-2 py-md-3 uLT-f-radius-sB" textClasses={`px-md-4 cLT-white-text ${mediaMD ? 'fLT-Regular-sA' : 'fLT-Regular-sC'} `} innerText="اطلب عرض سعر" />
                </div>
              </NavLink>
            </div>
          </div>
